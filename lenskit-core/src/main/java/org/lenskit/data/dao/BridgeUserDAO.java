...
public class BridgeUserDAO implements UserDAO {
     ...
     */
    @Inject
    public BridgeUserDAO(DataAccessObject dao) {
        delegate = dao;
    }

    @Override
    public LongSet getUserIds() {
        return delegate.getEntityIds(CommonTypes.USER);
    }

    public static class DynamicProvider implements Provider<UserDAO> {
