 ...
 *
 */
public interface UserItemDataSession {
    /**
     * Retrieve the DAO that created this session.
     * @return
     */
    UserItemDataAccessObject getDAO();
    ...
    /**
     * Release the session, releasing or closing underlying resources as
     * appropriate.
     */
    void release();
}
