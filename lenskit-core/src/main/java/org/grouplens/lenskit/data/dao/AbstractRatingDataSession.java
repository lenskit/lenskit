...
/**
 * Absract implementation of {@link RatingDataSession}.
 * @author Michael Ekstrand <ekstrand@cs.umn.edu>
 *
 */
public abstract class AbstractRatingDataSession implements RatingDataSession {
    protected final RatingDataAccessObject dao;
    
    protected AbstractRatingDataSession(RatingDataAccessObject dao) {
        this.dao = dao;
    }
    ...
    /**
     * Implement {@link UserItemDataSession#release()} as a no-op.
     */
    @Override
    public void release() {
    }
