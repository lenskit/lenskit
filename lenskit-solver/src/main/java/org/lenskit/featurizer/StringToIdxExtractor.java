...
public class StringToIdxExtractor implements FeatureExtractor {
    ...
    /**
     * Convert a string-typed attribute in entity to be a one-hot encoded categorical feature with feature value one.
     * The attrName together with its attribute value (i.e. a string) are treated as the key. It will extract
