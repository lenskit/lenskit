...
/**
 * A <tt>RatingRecommender</tt> that uses a weighted Slope One algorithm.
 */
public class WeightedSlopeOneRatingRecommender extends AbstractRatingRecommender{

	private WeightedSlopeOneRatingPredictor predictor; 
	
	/**
     * Construct a new recommender from a predictor.
     * @param predictor The predictor to use.
     */
    public WeightedSlopeOneRatingRecommender(WeightedSlopeOneRatingPredictor predictor) {
