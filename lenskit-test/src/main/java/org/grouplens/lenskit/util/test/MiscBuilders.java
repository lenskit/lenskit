...
/**
 * Methods for building various kinds of things.
 */
public class MiscBuilders {
    /**
     * Create a Typesafe config block from a JSON closure, using {@link JsonBuilder}.
     *
    ...
    public static Config configObj(Closure block) {
        ...
        return ConfigFactory.parseString(bld.toString(), options);
    }
